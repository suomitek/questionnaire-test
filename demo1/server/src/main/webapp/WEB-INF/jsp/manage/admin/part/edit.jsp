	...
	<form class="form form-horizontal" id="submintInfo" method="post" >
		<div class="row cl">
			...
			<div class="formControls col-sm-8">
				<input id="roleName" name="roleName" class="input-text toJson" placeholder="ROLE名称" type="text" value="${obj.roleName}">
		...
		<div class="row cl">
			...
			<div class="formControls col-sm-8">
				<textarea id="roleDesc" name="roleDesc" class="textarea toJson" placeholder="请输入ROLE描述">${obj.roleDesc}</textarea>
			</div>
		</div>
		<div class="row cl">
