...
<div class="pd-20">
	...
	<div  class="cl pd-5 bg-1 bk-gray mt-20">
		<shiro:hasPermission name="/${url}/add">
			<span class="l"><a href="javascript:;" onclick="object_show('新增前台ROLE','${basePath }/${url}/add',800,400)" class="btn btn-primary radius size-MINI"><i class="Hui-iconfont">&#xe600;</i> 新增前台ROLE</a></span>
		</shiro:hasPermission>
	</div>
	<table id="cckj_datatable" class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="5" class="text-c">前台ROLE列表</th>
			</tr>
			<tr class="text-c">
				<th width="30">序号</th>
				<th width="30">ROLE名称</th>
				<th width="30">ROLE描述</th>
				<th width="30">创建时间</th>
				<th width="120">操作</th>
			</tr>
		</thead>
            ...
            "columns":[
                ...
                {"data":"id",
                    ...
                    "render":function(data, type, full, meta){
                        ...
                        str +="<a title='指定权限' href='javascript:;' onclick=\"object_show('指定权限','${basePath}/${url}/distribution?id="+data+"',800,500)\" class='btn btn-primary radius size-MINI' style='margin-left:10px;'>";
                        str +="<i class='Hui-iconfont'>&#xe6df;</i>指定权限</a>";
                        </shiro:hasPermission>
                        <shiro:hasPermission name="/${url}/edit">
                        str +="<a title='编辑' href='javascript:;' onclick=\"object_show('前台ROLE编辑','${basePath}/${url}/edit?id="+data+"',800,500)\" class='btn btn-primary radius size-MINI' style='margin-left:10px;'>";
