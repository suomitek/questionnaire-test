...
<nav class="breadcrumb">
	...
	<a class="btn btn-success radius r mr-20" id="refreshList" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
</nav>
<div class="pd-20">
	...
	<shiro:hasPermission name="/manage/admin/role/add">
		<div  class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="object_show('新增角色','${basePath}/manage/admin/role/add',600,300)" class="btn btn-primary radius  size-MINI"><i class="Hui-iconfont">&#xe600;</i> 新增角色</a></span>
		</div>
	</shiro:hasPermission>
	<table id="cckj_datatable" class="table table-border table-bordered table-bg">
		<thead>
		<tr>
			<th scope="col" colspan="7" class="text-c">角色列表</th>
		</tr>
		<tr class="text-c">
			<th width="30">序号</th>
			<th width="30">角色名称</th>
...
<script type="text/javascript">
    ...
    function inittable(){
        table = $('#cckj_datatable').dataTable({
            ...
            "ajax":{
                "url":'${basePath}/manage/admin/role/listJson',
                "type":"GET",
                "data": function ( d ) {
                    return $.extend( {}, d, {
            ...
            "columns":[
                ...
                {"data":"roleName","orderable":false,"className":"td-manage text-c"},
                {"data":"roleDesc","orderable":false,"className":"td-manage text-c"},
                {"data":"roleType","orderable":false,"className":"td-manage text-c"},
                {"data":"id",
                    "className":"td-manage text-c","orderable":false,
                    "render":function(data, type, full, meta){
                        var str = "";
						<shiro:hasPermission name="/manage/admin/resource/listRoleZtree">
                        str +="<a title='菜单权限' href='javascript:;' onclick=\"object_show('菜单权限','${basePath}/manage/admin/resource/listRoleZtree?sysRoleId="+data+"',600,300)\"\" class='btn btn-primary radius size-MINI' style='margin-left:10px;'>";
                        str +="<i class='Hui-iconfont'>&#xe6df;</i>菜单权限</a>";
                        </shiro:hasPermission>
                        <shiro:hasPermission name="/manage/admin/role/edit">
                        str +="<a title='编辑' href='javascript:;' onclick=\"object_show('角色编辑','${basePath}/manage/admin/role/edit?sysRoleId="+data+"',600,300)\"\" class='btn btn-primary radius size-MINI' style='margin-left:10px;'>";
                        str +="<i class='Hui-iconfont'>&#xe6df;</i>编辑</a>";
                        </shiro:hasPermission>
                        <shiro:hasPermission name="/manage/admin/role/delete">
    ...
    function object_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            ...
            $.ajax({
                type:'post',
                url:'${basePath}/manage/admin/role/delete',// 跳转到 action
                cache:false,
                data:{"roleId":id},
                dataType:'json',
