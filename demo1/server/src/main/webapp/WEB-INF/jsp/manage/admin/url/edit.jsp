	...
	<form class="form form-horizontal" id="submintInfo" method="post" >
		<div class="row cl">
			...
			<div class="formControls col-sm-8">
				<input id="linkName" name="linkName" class="input-text toJson" placeholder="URL名称" type="text" value="${obj.linkName}">
		...
		<div class="row cl">
			...
			<div class="formControls col-sm-8">
				<input id="linkCode" name="linkCode" class="input-text toJson" placeholder="URL编码" type="text" value="${obj.linkCode}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-sm-2" for="linkUrl" style="text-align: right"><span class="c-red">*</span>URL地址：</label>
			<div class="formControls col-sm-8">
				<input id="linkUrl" name="linkUrl" class="input-text toJson" placeholder="URL地址" type="text" value="${obj.linkUrl}">
			</div>
		</div>
		<div class="row cl">
