	...
	<form class="form form-horizontal" id="submintInfo" method="post" >
		<div class="row cl">
			...
			<div class="formControls col-sm-8 col-xs-8">
				<input id="roleName" name="roleName" class="input-text" placeholder="请输入角色名称" type="text">
		...
		<div class="row cl">
			...
			<div class="formControls col-sm-8 col-xs-8">
				<textarea id="roleDesc" name="roleDesc" class="textarea" placeholder="请输入角色描述"></textarea>
			</div>
		</div>
...
<script type="text/javascript">
    $().ready(function() {
        ...
        $.ajax({
            ...
            cache:false,
            async:false,
            data:{"checkVal":value,"attribute":message,"userId":$("#userId").val()},
            dataType:'json',
        ...
        jQuery("#submintInfo").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax( {
                    url:'${basePath}/manage/admin/role/addSave',// 跳转到 action
                    type:'post',
                    cache:false,
