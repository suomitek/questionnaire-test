...
<article class="page-container">
	<form class="form form-horizontal" id="submintInfo" method="post" >
		<div class="row cl">
			<label class="form-label col-sm-2" for="name" style="text-align: right"><span class="c-red">*</span>验证标题：</label>
			<div class="formControls col-sm-8">
				<input id="name" name="name" class="input-text toJson" placeholder="验证标题" type="text">
