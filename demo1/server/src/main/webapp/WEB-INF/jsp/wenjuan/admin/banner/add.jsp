	...
	<form class="form form-horizontal" id="submintInfo" method="post" >
		<div class="row cl">
			...
			<div class="formControls col-sm-8">
				<input id="title" name="title" class="input-text toJson" placeholder="轮播标题" type="text">
		...
		<div class="row cl">
			...
			<div class="formControls col-sm-8">
				<input id="linkUrl" name="linkUrl" class="input-text toJson" placeholder="链接" type="text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-2" style="text-align: right"><span class="c-red">*</span>轮播图片：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<img style="width: 90%;" src="${basePath }/static/shop/banner.jpg" id="imagePathShow" onclick="link('#imagePathShow','#imagePath')"/>
				<input id="imagePath" type="hidden" value="${basePath }/static/shop/banner.jpg" class="toJson">
			</div>
		</div>
