...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>验证列表 <a class="btn btn-success radius r mr-20" id="refreshList" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
	<div class="text-c">
	...
	<div  class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l"><a href="javascript:;" onclick="object_show('新增验证','${basePath }/${url}/add',800,400)" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 新增验证</a></span>
	</div>
	<table id="cckj_datatable" class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="8" class="text-c">验证列表</th>
			</tr>
			<tr class="text-c">
				<th width="30">序号</th>
				<th width="30">名称</th>
    ...
    function inittable(){
        table = $('#cckj_datatable').dataTable({
            ...
            "columns":[
                ...
                {"data":"icon","orderable":false,"className":"td-manage text-c"},
                {"data":"reg","orderable":false,"className":"td-manage text-c"},
                {"data":"orderNum","orderable":false,"className":"td-manage text-c"},
                {"data":"msg","orderable":false,"className":"td-manage text-c"},
                {"data":"createTime",
                ...
                {"data":"id",
                    ...
                    "render":function(data, type, full, meta){
                        ...
                        str +="<a title='编辑' href='javascript:;' onclick=\"object_show('验证编辑','${basePath}/${url}/edit?id="+data+"',800,400)\" class='btn btn-primary radius size-MINI' style='margin-left:10px;'>";
