...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>问卷列表 <a class="btn btn-success radius r mr-20" id="refreshList" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
	<div class="text-c">
	...
	<div  class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l"><a href="javascript:;" onclick="object_show('新增问卷','${basePath }/${url}/add',800,500)" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 新增问卷</a></span>
	</div>
	<table id="cckj_datatable" class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="7" class="text-c">问卷列表</th>
			</tr>
			<tr class="text-c">
				<th width="30">序号</th>
				<th width="40">图片</th>
    ...
    function inittable(){
        table = $('#cckj_datatable').dataTable({
            ...
            "columns":[
                ...
                {"data":"introduce","orderable":false,"className":"td-manage text-c"},
                {"data":"voteCode","orderable":false,"className":"td-manage text-c"},
                {"data":"startTime",
                ...
                {"data":"id",
                    ...
                    "render":function(data, type, full, meta){
                        ...
                        str +="<a title='编辑' href='javascript:;' onclick=\"object_show('问卷编辑','${basePath}/${url}/edit?id="+data+"',800,500)\" class='btn btn-primary radius size-MINI' style='margin-left:10px;'>";
