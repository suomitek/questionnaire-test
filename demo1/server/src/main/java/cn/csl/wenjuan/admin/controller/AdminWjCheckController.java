...
@Controller
@RequestMapping({"/wenjuan/admin/check"})
public class AdminWjCheckController {
    @Resource
    ...
    @ResponseBody
    public ResultResponse addSave(WjCheck wjCheck){
        ResultResponse response = new ResultResponse();
        try{
            response = this.getBasicsService().addSave(wjCheck);
        }
        catch (Exception e){
            e.printStackTrace();
    ...
    public String edit(Model model, String id){
        model.addAttribute("url", getBasicsUrl());
        WjCheck obj = this.getBasicsService().selectByPrimaryKey(id);
    ...
    @ResponseBody
    public ResultResponse editSave(WjCheck wjCheck){
        ResultResponse response = new ResultResponse();
        try{
            response = this.getBasicsService().editSave(wjCheck);
        }catch (Exception e){
            e.printStackTrace();
