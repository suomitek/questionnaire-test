...
//    System.out.println("过滤html代码: "+RegexUtil.htmltoText("<JAVASCRIPT>12</JAVASCRIPT>DDDDD"));
    ...
    @CheckAnntaionMessage(message =  "必选字段")
     ...
     * @author vinc
     */
    @CheckAnntaionMessage(message =  "请输入正确的网址")
     ...
     * @author vinc
     */
    @CheckAnntaionMessage(message =  "只能包含字母、数字在6-12位之间")
    public final static boolean isPwd(String str) {
        return match(str, "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,12}$");
    }
     ...
     * @author vinc
     */
    @CheckAnntaionMessage(message = "请输入正确的邮箱")
     ...
     * @author vinc
     */
    @CheckAnntaionMessage(message = "只能输入数字")
     ...
     * @author vinc
     */
    @CheckAnntaionMessage(message = "请输入正确的手机号")
     ...
     * @author vinc
     */
    @CheckAnntaionMessage(message = "匹配")
